...
import { AuthzBindings, JwtStrategy, UserAccessLevel, UserWithUserDetail, UserWithUserDetailModel } from '../../common'
...
export class UagsNameNameUsersPostController {
  constructor(
  ...
  async [v1.uags.name.users.post.fn](
